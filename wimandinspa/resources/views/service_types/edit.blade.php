...
@section('page', 'Edit ServiceTypes')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>แก้ไขหมวดหมู่บริการ</h6>
                </div>
                <div class="card-body pb-2">
                    <form role="form" method="post" enctype="multipart/form-data" id="post-form"
                        action="{{ route('service_types.update',$service_types->id) }}">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col">              
                                ...
                                <div class="form-group @error('name') has-danger @enderror" >
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" type="text" value="{{ $service_types->name }}" name="name" id="name">
                                    @error('name')
